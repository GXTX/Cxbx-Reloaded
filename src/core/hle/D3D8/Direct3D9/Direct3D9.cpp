...
static void CxbxSetIndices(IDirect3DIndexBuffer* pHostIndexBuffer)
{
	...
	if (FAILED(hRet))
		CxbxrKrnlAbort("CxbxSetIndices: SetIndices Failed!"); // +DxbxD3DErrorString(hRet));
}
...
#define XB_TRAMPOLINES(XB_MACRO)                                                                                                                                                                                    \
  ...
  /*XB_MACRO(xbox::void_xt,       WINAPI,     D3DDevice_SetGammaRamp,                             (xbox::dword_xt, CONST X_D3DGAMMARAMP*)                                                                       );*/\
    ...
    XB_MACRO(xbox::hresult_xt,    WINAPI,     Direct3D_CreateDevice,                              (xbox::uint_xt, xbox::X_D3DDEVTYPE, HWND, xbox::dword_xt, xbox::X_D3DPRESENT_PARAMETERS*, xbox::X_D3DDevice**));  \
    XB_MACRO(xbox::hresult_xt,    WINAPI,     Direct3D_CreateDevice_16__LTCG_eax_BehaviorFlags_ebx_ppReturnedDeviceInterface, (xbox::uint_xt, xbox::X_D3DDEVTYPE, HWND, xbox::X_D3DPRESENT_PARAMETERS*)         );  \
    XB_MACRO(xbox::hresult_xt,    WINAPI,     Direct3D_CreateDevice_16__LTCG_eax_BehaviorFlags_ecx_ppReturnedDeviceInterface, (xbox::uint_xt, xbox::X_D3DDEVTYPE, HWND, xbox::X_D3DPRESENT_PARAMETERS*)         );  \
...
void CreateHostResource(xbox::X_D3DResource *pResource, DWORD D3DUsage, int iTextureStage, DWORD dwSize)
{
	...
	case xbox::X_D3DRTYPE_CUBETEXTURE: {
...
#ifdef CXBX_USE_D3D11
		ID3D11Resource *pNewHostResource = nullptr;
#else
		...
		case xbox::X_D3DRTYPE_SURFACE: {
			...
			SetHostSurface(pResource, _9_11(pNewHostSurface, pNewHostResource), iTextureStage);
		...
		case xbox::X_D3DRTYPE_TEXTURE: {
			...
			SetHostTexture(pResource, _9_11(pNewHostTexture, pNewHostResource), iTextureStage);
			EmuLog(LOG_LEVEL::DEBUG, "CreateHostResource : Successfully created %s (0x%.08X, 0x%.08X)",
		...
		case xbox::X_D3DRTYPE_VOLUMETEXTURE: {
			...
			hRet = g_pD3DDevice->CreateTexture3D(&desc, NULL, &pNewHostResource);
			...
			SetHostVolumeTexture(pResource, _9_11(pNewHostVolumeTexture, pNewHostResource), iTextureStage);
			EmuLog(LOG_LEVEL::DEBUG, "CreateHostResource : Successfully created %s (0x%.08X, 0x%.08X)",
		...
		case xbox::X_D3DRTYPE_CUBETEXTURE: {
			...
			SetHostCubeTexture(pResource, _9_11(pNewHostCubeTexture, pNewHostResource), iTextureStage);
